...
public class DatabaseManager {
    ...
    private void registerMappers() {
        ...
        jdbi.registerColumnMapper(Material.class, (resultSet, column, __) ->
                Material.valueOf(resultSet.getString(column))
        );

        // Write String -> Material
        jdbi.registerArgument((ArgumentFactory) (type, value, __) ->
                type == Material.class && value instanceof Material m
                        ? Optional.of((pos, stmt, ___) -> stmt.setString(pos, m.name()))
                        : Optional.empty()
        );
    }
